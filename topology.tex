...
%  Your definition of separation is wrong. You need X' \cap Y' \cap S =
%  \emptyset. Disjointness of X' and Y' cannot be guaranteed. For
%  example, {1,2} is a disconnected subset of N with the
%  finite-complement topology, but 1 & 2 cannot be separated by open
%  nbhds.
...
% David Radcliffe points out that the following claim is false, since
% it fails for constant sequences.  Can it be fixed?
...
Gould, and Gery Debongnie, who offered advice and corrections on
